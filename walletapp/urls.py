...
from .views import register_thirdparty,register_notification,register_customer,register_currency,register_wallet,register_account,register_transaction,register_card,register_receipt,register_loan
